...
const SubmissionModal: React.FC<SubmissionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in-up">
      <div className="bg-background border border-border shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto rounded-2xl">
        {/* Header - More solid background */}
        <div className="flex items-center justify-between p-6 border-b border-border bg-card/50 backdrop-blur-md">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-xl bg-card border border-border text-foreground hover:bg-accent transition-all duration-300"
          >
            <svg
              width="24"
              height="24"
        ...
        <div className="flex border-b border-border bg-card/30">
          {[
            ...
            <button
              key={tab.id}
              onClick={() =>
                setActiveTab(tab.id as "details" | "attachments" | "history")
              }
        ...
        {/* Content - Better background */}
        <div className="p-6 bg-background">
          {activeTab === "details" && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Left Column */}
              <div className="space-y-6">
                {/* Citizen Information - Much more solid background */}
                ...
                {/* Form Data - Much more solid background */}
                <div className="bg-card border border-border rounded-xl p-6 shadow-lg">
                  <h3 className="text-lg font-semibold text-foreground mb-4 flex items-center gap-2">
                    <svg
                      width="20"
              ...
              {/* Right Column */}
              <div className="space-y-6">
                {/* Submission Details - Much more solid background */}
                <div className="bg-card border border-border rounded-xl p-6 shadow-lg">
                ...
                {submission.requestedInfo &&
                  submission.requestedInfo.length > 0 && (
                    <div className="bg-card border border-border rounded-xl p-6 shadow-lg">
                      <h3 className="text-lg font-semibold text-foreground mb-4">
                        {t.requestedInfo}
                      </h3>
                    ...
                    >
                      ...
                      <div className="flex gap-2 mt-3">
                        <button
                          ...
                          className="flex-1 px-3 py-2 bg-accent border border-border rounded-lg text-xs font-medium text-foreground hover:bg-accent/70 transition-all duration-300"
                        >
                          {t.viewDocument}
                        </button>
                        <button
                ...
                <div className="text-center py-12">
                  <div className="bg-card border border-border rounded-xl p-8">
                    ...
                    <p className="text-muted-foreground">
                      This submission has no attached documents
                    </p>
                  </div>
                </div>
              )}
          ...
          {activeTab === "history" && (
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4 p-4 bg-card border border-border rounded-xl shadow-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Form submitted by {submission.citizenName}
                    </p>
                  </div>
                </div>
                ...
                {submission.status !== "pending" && (
                  <div className="flex gap-4 p-4 bg-card border border-border rounded-xl shadow-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-foreground">
                        Status Updated: {t.statuses[submission.status]}
                      </h4>
                      <p className="text-sm text-muted-foreground">
                        {formatDate(submission.lastUpdated)}
                      </p>
        ...
        {/* Footer - Better background */}
        <div className="flex justify-between items-center gap-4 p-6 border-t border-border bg-card/50 backdrop-blur-md">
          <button
            onClick={onClose}
            className="px-6 py-3 bg-accent border border-border rounded-xl text-foreground hover:bg-accent/70 transition-all duration-300"
          >
            {t.close}
          </button>
