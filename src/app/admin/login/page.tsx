  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        <div
          className="absolute top-1/4 right-1/4 w-64 h-64 bg-[#8D153A]/8 dark:bg-[#8D153A]/4 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "8s" }}
        ></div>
        <div
          className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-[#FF5722]/8 dark:bg-[#FF5722]/4 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "12s", animationDelay: "4s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#FFC72C]/6 dark:bg-[#FFC72C]/3 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "10s", animationDelay: "2s" }}
        ></div>
        {/* Additional subtle accents */}
        <div
          className="absolute top-3/4 right-1/3 w-48 h-48 bg-[#008060]/6 dark:bg-[#008060]/3 rounded-full blur-2xl animate-pulse"
    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden theme-transition-slow">
        ...
        <nav className="container mx-auto flex items-center justify-between px-4 py-3 md:px-6 md:py-4">
          <Link href="/" className="flex items-center space-x-3 group">
            ...
            <div className="flex flex-col">
              <span className="text-xl md:text-2xl font-bold bg-gradient-to-r from-[#8D153A] to-[#FF5722] bg-clip-text text-transparent leading-none">
                GovLink
              </span>
      ...
      <main className="flex-1 flex items-center justify-center px-4 sm:px-6 py-12 sm:py-16 md:py-20 pt-20 sm:pt-24 md:pt-28 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div
            className="bg-card/90 dark:bg-card/95 backdrop-blur-md rounded-2xl border border-border/50 hover:border-[#8D153A]/70 hover:shadow-2xl transition-all duration-500 animate-fade-in-up modern-card p-6 sm:p-8 shadow-glow"
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <button
                  ...
                  style={{
                    boxShadow:
                      "0 4px 14px 0 rgba(141, 21, 58, 0.3), 0 8px 32px rgba(255, 87, 34, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-muted-foreground bg-card/50 backdrop-blur-sm px-4 py-2 rounded-xl border border-border/30">
              This is a secure government portal. All activities are monitored
              and logged.
            </p>
          </div>
        </div>
