...
const translations: Record<Language, HomeTranslations> = {
  en: {
    ...
    heroSubtitle:
      "Ask questions, find services, and access government information instantly.",
    ...
    features: {
      documents: {
        ...
        description:
          "Instantly find and download official government forms for passports, licenses, and more.",
        benefits: [
          "📥 Instant Downloads",
          "🕒 24/7 Availability",
          "📁 Multiple Formats",
      ...
      information: {
        ...
        description:
          "Ask any question about public services and get clear, step-by-step guidance.",
        benefits: [
          "⚡ Real-time Answers",
          "📋 Step-by-step Guides",
      ...
      appointments: {
        ...
        description:
          "Find available slots and book appointments with government departments online.",
        benefits: [
          "📅 Online Booking",
          "📱 SMS Reminders",
          "🔄 Easy Rescheduling",
    ...
    aboutDescription:
      "Making government services accessible, transparent, and efficient for every Sri Lankan citizen. Our platform revolutionizes how citizens interact with government departments, eliminating bureaucratic hurdles and streamlining essential processes.",
    aboutFeatures: {
      simplified: {
        title: "Simplified Access",
        description:
          "One unified platform for all government services. No more visiting multiple departments or websites. Everything you need is accessible from a single dashboard.",
      },
      availability: {
        title: "24/7 Availability",
        description:
          "Access government services anytime, anywhere. Our digital platform never closes, ensuring you can complete tasks at your convenience, even outside office hours.",
      },
      transparent: {
        title: "Transparent Process",
        description:
          "Clear step-by-step guidance with real-time tracking. Know exactly what documents you need, how long processes take, and track your application status every step of the way.",
      },
    },
    aboutButtons: {
    ...
    aboutTrust: {
      ...
      description:
        "Officially endorsed by the Ministry of Public Administration and recognized as the primary digital gateway for citizen services in Sri Lanka.",
    },
    ...
    faq: {
      ...
      questions: {
        forms: {
          ...
          answer:
            "Simply search for the form you need or browse our services section. All forms are available for instant download.",
        },
        official: {
          question: "Is GovLink an official platform?",
          answer:
            "Yes, GovLink is officially endorsed by the Government of Sri Lanka for digital service delivery.",
        },
        tracking: {
          question: "Can I track my application status?",
          answer:
            "Absolutely! Use your application reference number to track the progress of your submissions.",
        },
        support: {
          question: "What if I need technical support?",
          answer:
            "Our technical support team is available 24/7 via phone, email, or live chat to assist you.",
        },
      },
    },
    ...
    footer: {
      description:
        "🇱🇰 Simplifying government services for every Sri Lankan. Access information, download forms, and complete procedures with ease through our modern digital platform.",
      quickLinks: {
        services: "🛡️ Services",
        about: "🏛️ About Us",
        contact: "📞 Contact",
      ...
      copyright:
        "GovLink Sri Lanka. An initiative to streamline public services.",
  ...
  si: {
    ...
    heroSubtitle:
      "ප්‍රශ්න ඇසීම, සේවා සොයාගැනීම, සහ රජයේ තොරතුරු ක්ෂණිකව ලබාගැනීම.",
    ...
    featuresDescription:
      "GovLink නිර්මාණය කර ඇත්තේ රජයේ සේවා සමග ඔබේ අන්තර්ක්‍රියාව සුමට හා කාර්යක්ෂම කිරීමට ය.",
    features: {
      documents: {
        title: "ආකෘති පත්‍ර සහ ලේඛන වෙත ප්‍රවේශය",
        description:
          "ගමන් බලපත්‍ර, බලපත්‍ර සහ තවත් බොහෝ දේ සඳහා නිල රජයේ ආකෘති පත්‍ර ක්ෂණිකව සොයා බාගන්න.",
        benefits: [
          "📥 ක්ෂණික බාගත කිරීම්",
          "🕒 24/7 ලබාගත හැකි",
          "📁 විවිධ ආකෘති",
      ...
      information: {
        ...
        description:
          "පොදු සේවා ගැන ඕනෑම ප්‍රශ්නයක් අසා පැහැදිලි, පියවරින් පියවර මඟපෙන්වීම ලබාගන්න.",
        benefits: [
          "⚡ තත්‍ය කාලීන පිළිතුරු",
          "📋 පියවරින් පියවර මාර්ගෝපදේශන",
          "🌐 බහුභාෂා සහාය",
        ],
      },
      appointments: {
        ...
        description:
          "රජයේ දෙපාර්තමේන්තු සමග අන්තර්ජාලය හරහා ලබාගත හැකි වේලාවන් සොයා හමුවීම් වෙන්කරවාගන්න.",
        benefits: [
          "📅 අන්තර්ජාල වෙන්කිරීම්",
          "📱 SMS මතක්කරුවන්",
          "🔄 පහසු නැවත සකස් කිරීම",
        ],
      },
    },
    ...
    aboutDescription:
      "සෑම ශ්‍රී ලාංකික පුරවැසියකු සඳහාම රජයේ සේවා ප්‍රවේශ විය හැකි, විනිවිද පෙනෙන සහ කාර්යක්ෂම කිරීම. අපගේ වේදිකාව පුරවැසියන් රජයේ දෙපාර්තමේන්තු සමග අන්තර්ක්‍රියා කරන ආකාරය විප්ලවීය වෙනසක් ඇති කරයි.",
    aboutFeatures: {
      simplified: {
        title: "සරල කළ ප්‍රවේශය",
        description:
          "සියළුම රජයේ සේවා සඳහා එක ඒකාබද්ධ වේදිකාවක්. තවදුරටත් බහුවිධ දෙපාර්තමේන්තු හෝ වෙබ් අඩවි වෙත යාමක් නැත. ඔබට අවශ්‍ය සියල්ල එකම උපකරණ පුවරුවකින් ප්‍රවේශ කළ හැකිය.",
      },
      availability: {
        title: "24/7 ලබාගත හැකිබව",
        description:
          "ඕනෑම වේලාවක, ඕනෑම තැනක රජයේ සේවා වෙත ප්‍රවේශ වන්න. අපගේ ඩිජිටල් වේදිකාව කිසි විටක වසා නොදමයි, කාර්යාල කාලයෙන් පිටත පවා ඔබට පහසුවෙන් කාර්යයන් සම්පූර්ණ කළ හැකිය.",
      },
      transparent: {
        title: "විනිවිද පෙනෙන ක්‍රියාවලිය",
        description:
          "තත්‍ය කාලීන ලුහුබැඳීම සමඟ පැහැදිලි පියවරින් පියවර මඟපෙන්වීම. ඔබට අවශ්‍ය ලේඛන මොනවාද, ක්‍රියාවලි කොපමණ කාලයක් ගතවේද, සහ ඔබේ අයදුම්පත්‍රයේ තත්ත්වය සෑම පියවරකදීම ලුහුබැඳීම.",
      },
    },
    aboutButtons: {
    ...
    aboutTrust: {
      title: "රජයේ විශ්වාසය",
      description:
        "මහජන පරිපාලන අමාත්‍යංශයේ නිල අනුමැතිය සහ ශ්‍රී ලංකාවේ පුරවැසි සේවා සඳහා මූලික ඩිජිටල් ගේට්වේ ලෙස පිළිගැනීම.",
    },
    ...
    contactDescription:
      "රජයේ සේවා ගැන ප්‍රශ්න තිබේද? අපගේ සහාය කණ්ඩායම ඔබට සහාය වීමට සූදානම්.",
    contactMethods: {
      phone: {
    ...
    faq: {
      ...
      questions: {
        forms: {
          ...
          answer:
            "ඔබට අවශ්‍ය ආකෘතිය සඳහා සෙවීම හෝ අපගේ සේවා අංශය පිරික්සීම පමණි. සියළුම ආකෘති ක්ෂණික බාගත කිරීම සඳහා ලබාගත හැකිය.",
        },
        official: {
          question: "GovLink නිල වේදිකාවක්ද?",
          answer:
            "ඔව්, GovLink ඩිජිටල් සේවා සැපයීම සඳහා ශ්‍රී ලංකා රජයේ නිල අනුමැතිය ලබා ඇත.",
        },
        tracking: {
          question: "මගේ අයදුම්පත්‍රයේ තත්ත්වය ලුහුබැඳීමට හැකිද?",
          answer:
            "අනිවාර්යයෙන්! ඔබේ අයදුම් සිටුවම්වල ප්‍රගතිය ලුහුබැඳීම සඳහා ඔබේ අයදුම්පත්‍ර යොමු අංකය භාවිතා කරන්න.",
        },
        support: {
          question: "මට තාක්ෂණික සහාය අවශ්‍ය නම් කුමක් කළ යුතුද?",
          answer:
            "අපගේ තාක්ෂණික සහාය කණ්ඩායම දුරකථනය, ඊමේල් හෝ සජීවි චැට් හරහා 24/7 ඔබට සහාය වීමට ලැබී ඇත.",
        },
      },
    },
    ...
    footer: {
      description:
        "🇱🇰 සෑම ශ්‍රී ලාංකිකයකු සඳහාම රජයේ සේවා සරල කිරීම. අපගේ නවීන ඩිජිටල් වේදිකාව හරහා පහසුවෙන් තොරතුරු ප්‍රවේශ කිරීම, ආකෘති බාගත කිරීම සහ ක්‍රියාවලි සම්පූර්ණ කිරීම.",
      quickLinks: {
        services: "🛡️ සේවා",
        about: "🏛️ අප ගැන",
        contact: "📞 සම්බන්ධවීම",
  ...
  ta: {
    ...
    heroSubtitle:
      "கேள்விகளைக் கேளுங்கள், சேவைகளைக் கண்டறியுங்கள், மற்றும் அரசாங்க தகவல்களை உடனடியாகப் பெறுங்கள்.",
    ...
    featuresDescription:
      "அரசாங்கச் சேவைகளுடனான உங்கள் தொடர்புகளை தடையற்றதாகவும் வினைத்திறனாகவும் மாற்ற GovLink வடிவமைக்கப்பட்டுள்ளது.",
    features: {
      documents: {
        title: "படிவங்கள் மற்றும் ஆவணங்களை அணுகவும்",
        description:
          "கடவுச்சீட்டுக்கள், உரிமங்கள் மற்றும் பலவற்றிற்கான அதிகாரப்பூர்வ அரசாங்கப் படிவங்களை உடனடியாகக் கண்டறிந்து பதிவிறக்கம் செய்யுங்கள்.",
        benefits: [
          "📥 உடனடிப் பதிவிறக்கங்கள்",
          "🕒 24/7 சேவை",
          "📁 பல வடிவங்கள்",
        ],
      },
      information: {
        ...
        description:
          "பொதுச் சேவைகள் பற்றிய எந்தவொரு கேள்வியையும் கேட்டு, தெளிவான, படிப்படியான வழிகாட்டுதலைப் பெறுங்கள்.",
        benefits: [
          "⚡ நிகழ்நேர பதில்கள்",
      ...
      appointments: {
        ...
        description:
          "கிடைக்கக்கூடிய நேரங்களை கண்டறிந்து, அரசாங்கத் துறைகளுடன் இணையத்தில் சந்திப்புகளை முன்பதிவு செய்யுங்கள்.",
        benefits: [
          "📅 இணைய முன்பதிவு",
          "📱 SMS நினைவூட்டல்கள்",
          "🔄 எளிய மறுதிட்டமிடல்",
    ...
    aboutDescription:
      "ஒவ்வொரு இலங்கைக் குடிமகனுக்கும் அரசாங்கச் சேவைகளை அணுகக்கூடியதாக, வெளிப்படையாகவும், வினைத்திறனாகவும் மாற்றுதல். எங்கள் தளம் குடிமக்கள் அரசாங்கத் துறைகளுடன் தொடர்புகொள்ளும் விதத்தில் புரட்சிகரமானது.",
    aboutFeatures: {
      simplified: {
        title: "எளிமைப்படுத்தப்பட்ட அணுகல்",
        description:
          "அனைத்து அரசாங்கச் சேவைகளுக்கும் ஒரு ஒருங்கிணைந்த தளம். இனி பல துறைகள் அல்லது இணையதளங்களுக்குச் செல்ல வேண்டாம். உங்களுக்குத் தேவையான அனைத்தும் ஒரே தரவுப் பலகை மூலம் அணுகக்கூடியது.",
      },
      availability: {
        title: "24/7 சேவை",
        description:
          "எந்த நேரத்திலும், எங்கிருந்தும் அரசாங்கச் சேவைகளை அணுகுங்கள். எங்கள் டிஜிட்டல் தளம் ஒருபோதும் மூடுவதில்லை, அலுவலக நேரங்களுக்கு வெளியேயும் உங்கள் வசதிக்கேற்ப பணிகளை முடிக்க முடியும்.",
      },
      transparent: {
        title: "வெளிப்படையான செயல்முறை",
        description:
          "நிகழ்நேரக் கண்காணிப்புடன் தெளிவான படிப்படியான வழிகாட்டுதல். உங்களுக்குத் தேவையான ஆவணங்கள் என்னென்ன, செயல்முறைகள் எவ்வளவு நேரம் எடுக்கும், மற்றும் ஒவ்வொரு படியிலும் உங்கள் விண்ணப்ப நிலையைக் கண்காணிக்கவும்.",
      },
    },
    aboutButtons: {
    ...
    aboutTrust: {
      ...
      description:
        "பொது நிர்வாக அமைச்சகத்தின் அதிகாரப்பூர்வ ஒப்புதல் மற்றும் இலங்கையில் குடிமக்கள் சேவைகளுக்கான முதன்மை டிஜிட்டல் நுழைவாயிலாக அங்கீகரிக்கப்பட்டது.",
    },
    ...
    contactDescription:
      "அரசாங்கச் சேவைகள் பற்றி கேள்விகள் உள்ளதா? எங்கள் ஆதரவு குழு உங்களுக்கு உதவத் தயாராக உள்ளது.",
    contactMethods: {
      phone: {
    ...
    faq: {
      ...
      questions: {
        forms: {
          ...
          answer:
            "உங்களுக்குத் தேவையான படிவத்தைத் தேடவும் அல்லது எங்கள் சேவைகள் பிரிவைப் பார்க்கவும். அனைத்துப் படிவங்களும் உடனடிப் பதிவிறக்கத்திற்குக் கிடைக்கின்றன.",
        },
        official: {
          question: "GovLink அதிகாரப்பூர்வ தளமா?",
          answer:
            "ஆம், GovLink டிஜிட்டல் சேவை வழங்கலுக்காக இலங்கை அரசாங்கத்தால் அதிகாரப்பூர்வமாக ஒப்புதல் அளிக்கப்பட்டுள்ளது.",
        },
        tracking: {
          question: "எனது விண்ணப்ப நிலையைக் கண்காணிக்க முடியுமா?",
          answer:
            "நிச்சயமாக! உங்கள் சமர்பிப்புகளின் முன்னேற்றத்தைக் கண்காணிக்க உங்கள் விண்ணப்பக் குறிப்பு எண்ணைப் பயன்படுத்துங்கள்.",
        },
        support: {
          question: "எனக்குத் தொழில்நுட்ப ஆதரவு தேவைப்பட்டால் என்ன செய்வது?",
          answer:
            "எங்கள் தொழில்நுட்ப ஆதரவுக் குழு தொலைபேசி, மின்னஞ்சல் அல்லது நேரடி காணொலி அழைப்பு மூலம் 24/7 உங்களுக்கு உதவி கிடைக்கிறது.",
        },
      },
    },
    ...
    footer: {
      description:
        "🇱🇰 ஒவ்வொரு இலங்கையருக்கும் அரசாங்கச் சேவைகளை எளிமைப்படுத்துதல். எங்கள் நவீன டிஜிட்டல் தளத்தின் மூலம் எளிதாகத் தகவல்களை அணுகவும், படிவங்களைப் பதிவிறக்கம் செய்யவும், மற்றும் நடைமுறைகளை முடிக்கவும்.",
      quickLinks: {
        services: "🛡️ சேவைகள்",
      ...
      copyright:
        "GovLink இலங்கை. பொதுச் சேவைகளை எளிமைப்படுத்துவதற்கான முயற்சி.",
...
const Hero = ({ language }: { language: Language }) => {
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
    ...
    if (e.key === "Enter") {
      ...
      const form = (e.currentTarget as HTMLTextAreaElement).closest(
        "form"
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mb-4 sm:mb-6 lg:mb-8 animate-fade-in-up">
            <h1
              ...
              } font-bold leading-tight mb-3 sm:mb-4 lg:mb-6`}
            >
              <span className="block text-foreground mb-1 sm:mb-2">
                {t.heroTitle1}
              </span>
              <span className="block text-gradient animate-title-wave">
                {t.heroTitle2}
              </span>
            </h1>
          ...
          {/* Compact Subtitle */}
          <p
            className="text-sm sm:text-base md:text-lg text-muted-foreground mb-4 sm:mb-6 lg:mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in-up font-light px-4 sm:px-0"
          ...
          <div
            className="max-w-3xl mx-auto animate-fade-in-up px-4 sm:px-0"
          ...
          >
              ...
              <div className="mt-3 sm:mt-4 flex flex-wrap gap-1.5 sm:gap-2 justify-center">
                {t.searchSuggestions.map((suggestion, index) => (
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setSearchText(suggestion.split(" ").slice(1).join(" "))
                    }
            ...
            <div
              className="flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2 lg:gap-4 animate-fade-in-up"
...
const Features = ({ language }: { language: Language }) => {
  ...
  return (
    <section
      id="services"
      className="py-4 sm:py-8 lg:py-12 -mt-4 sm:-mt-8 lg:mt-0 relative"
    >
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          {featuresList.map((feature, index) => (
            ...
            >
              ...
              <div className="p-3 sm:p-6 lg:p-8 flex flex-col h-full min-h-[280px] sm:min-h-[400px] lg:min-h-[450px]">
                ...
                <div
                  className="relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-xl mb-2 sm:mb-4 lg:mb-6 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6"
                  style={{
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="space-y-1.5 sm:space-y-2 lg:space-y-3 mt-auto">
                    {feature.benefits.map((benefit, benefitIndex) => (
                      <div
                        key={benefitIndex}
                        className="flex items-start gap-2 sm:gap-3 text-xs sm:text-sm group/benefit hover:translate-x-1 transition-transform duration-200"
                      >
                        ...
                        <span className="text-muted-foreground group-hover/benefit:text-foreground transition-colors duration-200 leading-relaxed break-words hyphens-auto flex-1">
                          {benefit}
                        </span>
                      </div>
                    ))}
    ...
    <section id="about" className="py-16 sm:py-20 relative">
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="animate-fade-in-up flex flex-col justify-between min-h-[600px] lg:min-h-[700px]">
            ...
            <div className="space-y-6 lg:space-y-8 mb-8 lg:mb-12">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <span className="font-semibold text-base lg:text-lg block mb-2">
                    {t.aboutFeatures.simplified.title}
                  </span>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <span className="font-semibold text-base lg:text-lg block mb-2">
                    {t.aboutFeatures.availability.title}
                  </span>
                  <p className="text-muted-foreground text-sm lg:text-base leading-relaxed">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <span className="font-semibold text-base lg:text-lg block mb-2">
                    {t.aboutFeatures.transparent.title}
                  </span>
                  <p className="text-muted-foreground text-sm lg:text-base leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="bg-gradient-to-r from-[#FFC72C] via-[#FF5722] to-[#8D153A] hover:from-[#FF5722] hover:via-[#8D153A] hover:to-[#FFC72C] text-white px-6 py-3.5 rounded-xl font-semibold text-sm lg:text-base transition-all duration-300 hover:scale-105 shadow-lg"
              >
                {t.aboutButtons.learnMore}
              </button>
              <button
                onClick={() => setShowMission(true)}
                className="border-2 border-[#008060] text-[#008060] hover:bg-[#008060] hover:text-white px-6 py-3.5 rounded-xl font-semibold text-sm lg:text-base transition-all duration-300 hover:scale-105"
              >
          ...
          <div
            className="animate-fade-in-up flex flex-col min-h-[600px] lg:min-h-[700px]"
            style={{ animationDelay: "0.2s" }}
          >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              <div className="text-center p-3 sm:p-4 lg:p-5 bg-card/90 dark:bg-card/95 backdrop-blur-md rounded-xl border border-border/50 modern-card hover:shadow-lg transition-all duration-300 flex flex-col justify-center min-h-[100px] sm:min-h-[110px] lg:min-h-[130px]">
                <div className="text-lg sm:text-xl lg:text-xl font-bold text-gradient mb-2 flex-shrink-0">
                  50K+
                </div>
                <div className="text-muted-foreground text-xs sm:text-xs lg:text-sm leading-tight break-words hyphens-auto px-1">
                  {t.aboutStats.citizens}
                </div>
              </div>
      ...
      {showLearnMore && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-card/95 backdrop-blur-md rounded-2xl border border-border/50 max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="p-6 sm:p-8">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-2xl sm:text-3xl font-bold text-gradient">
                  About GovLink Sri Lanka
                </h3>
                <button
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    GovLink was founded in 2022 with a simple yet powerful
                    vision: to make government services accessible, transparent,
                    and efficient for every Sri Lankan citizen. Born from the
                    frustration of lengthy bureaucratic processes and the need
                    for digital transformation in public service delivery.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    Our team of dedicated developers, public administration
                    experts, and user experience designers came together to
                    create a platform that bridges the gap between citizens and
                    government services, making essential processes simple and
                    straightforward.
                  </p>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-background/50 rounded-lg border border-border/30">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        ensuring intuitive navigation and clear information
                        presentation.
                      </p>
                    </div>
                    ...
                    <div className="p-4 bg-background/50 rounded-lg border border-border/30">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-8 h-8 bg-gradient-to-r from-[#008060] to-[#FFC72C] rounded-full flex items-center justify-center">
                          <svg
                            className="w-4 h-4 text-white"
                            fill="none"
                            stroke="currentColor"
                        ...
                        <h5 className="font-semibold">Lightning Fast</h5>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        Advanced technology stack ensures quick response times
                    ...
                    <div className="p-4 bg-background/50 rounded-lg border border-border/30">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-8 h-8 bg-gradient-to-r from-[#FF5722] to-[#8D153A] rounded-full flex items-center justify-center">
                          <svg
                            className="w-4 h-4 text-white"
                            fill="none"
                            stroke="currentColor"
                        ...
                        <h5 className="font-semibold">Secure & Trusted</h5>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        Bank-level security protocols protect your personal
                    ...
                    <div className="p-4 bg-background/50 rounded-lg border border-border/30">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-8 h-8 bg-gradient-to-r from-[#8D153A] to-[#FFC72C] rounded-full flex items-center justify-center">
                          <svg
                            className="w-4 h-4 text-white"
                            fill="none"
                            stroke="currentColor"
                      ...
                      <p className="text-sm text-muted-foreground">
                        Available in English, Sinhala, and Tamil to serve all
                        Sri Lankan communities effectively.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center p-4 bg-gradient-to-r from-[#FFC72C]/10 to-[#FF5722]/10 rounded-lg border border-border/30">
                    ...
                    <div className="text-center p-4 bg-gradient-to-r from-[#008060]/10 to-[#FFC72C]/10 rounded-lg border border-border/30">
                      <div className="text-2xl font-bold text-gradient mb-1">
                        200+
                      </div>
                      <div className="text-sm text-muted-foreground">
                    ...
                    <div className="text-center p-4 bg-gradient-to-r from-[#FF5722]/10 to-[#8D153A]/10 rounded-lg border border-border/30">
                      <div className="text-2xl font-bold text-gradient mb-1">
                        25
                      </div>
                      <div className="text-sm text-muted-foreground">
                    ...
                    <div className="text-center p-4 bg-gradient-to-r from-[#8D153A]/10 to-[#FFC72C]/10 rounded-lg border border-border/30">
                      <div className="text-2xl font-bold text-gradient mb-1">
                        99.8%
                      </div>
                      <div className="text-sm text-muted-foreground">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-3 bg-background/50 rounded-lg border border-border/30">
                      ...
                      <div>
                        <div className="font-semibold text-sm">
                          Best Digital Government Initiative 2023
                        </div>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-background/50 rounded-lg border border-border/30">
                      ...
                      <div>
                        <div className="font-semibold text-sm">
                          Innovation in Citizen Services 2024
                        </div>
                        <div className="text-xs text-muted-foreground">
                          UN Digital Government Awards
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="space-y-8">
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-[#FFC72C] to-[#FF5722] rounded-xl flex items-center justify-center">
                      <svg
                  ...
                  <div className="pl-15 space-y-4">
                    <p className="text-muted-foreground leading-relaxed text-lg">
                      To revolutionize the way Sri Lankan citizens interact with
                      government services by providing a unified, accessible,
                      and transparent digital platform that eliminates
                      bureaucratic barriers and empowers every citizen with the
                      tools they need to access public services efficiently.
                    </p>
                    <div className="bg-gradient-to-r from-[#FFC72C]/10 via-[#FF5722]/10 to-[#8D153A]/10 p-6 rounded-xl border border-border/30">
                      <h5 className="font-semibold mb-3 text-foreground">
                        Core Commitments:
                      </h5>
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          <div className="w-5 h-5 bg-gradient-to-r from-[#FFC72C] to-[#FF5722] rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-0.5">
                            ✓
                          </div>
                          <span className="text-muted-foreground text-sm">
                            Simplify access to government services for all
                            citizens
                          </span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-5 h-5 bg-gradient-to-r from-[#008060] to-[#FFC72C] rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-0.5">
                            ✓
                          </div>
                          <span className="text-muted-foreground text-sm">
                            Ensure equal access regardless of location,
                            language, or technical expertise
                          </span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-5 h-5 bg-gradient-to-r from-[#FF5722] to-[#8D153A] rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-0.5">
                            ✓
                          </div>
                          <span className="text-muted-foreground text-sm">
                            Maintain the highest standards of security and
                            privacy
                          </span>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-5 h-5 bg-gradient-to-r from-[#8D153A] to-[#FFC72C] rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-0.5">
                            ✓
                          </div>
                          <span className="text-muted-foreground text-sm">
                            Continuously innovate to improve service delivery
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-[#008060] to-[#FFC72C] rounded-xl flex items-center justify-center">
                      <svg
                        className="w-6 h-6 text-white"
                        fill="none"
                        stroke="currentColor"
                  ...
                  <div className="pl-15 space-y-4">
                    <p className="text-muted-foreground leading-relaxed text-lg">
                      To become the leading digital government platform in South
                      Asia, setting the standard for citizen-centric public
                      service delivery and inspiring digital transformation
                      across the region.
                    </p>
                    <div className="bg-gradient-to-r from-[#008060]/10 via-[#FFC72C]/10 to-[#FF5722]/10 p-6 rounded-xl border border-border/30">
                      <h5 className="font-semibold mb-3 text-foreground">
                        By 2030, we envision:
                      </h5>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-3">
                          <div className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-gradient-to-r from-[#FFC72C] to-[#FF5722] rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-1">
                              🌟
                            </div>
                            <div>
                              ...
                              <div className="text-xs text-muted-foreground">
                                All government services accessible digitally
                              </div>
                            </div>
                          </div>
                          <div className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-gradient-to-r from-[#008060] to-[#FFC72C] rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-1">
                              🎯
                            </div>
                            <div>
                              <div className="font-semibold text-sm mb-1">
                              ...
                              <div className="text-xs text-muted-foreground">
                                Completely paperless government processes
                              </div>
                            </div>
                          </div>
                          <div className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-gradient-to-r from-[#FF5722] to-[#8D153A] rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-1">
                              ⚡
                            </div>
                            <div>
                              <div className="font-semibold text-sm mb-1">
                              ...
                              <div className="text-xs text-muted-foreground">
                                Real-time service delivery for all requests
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="space-y-3">
                          <div className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-gradient-to-r from-[#8D153A] to-[#FFC72C] rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-1">
                              🌍
                            </div>
                            <div>
                              <div className="font-semibold text-sm mb-1">
                              ...
                              <div className="text-xs text-muted-foreground">
                                Benchmark for digital governance in South Asia
                              </div>
                            </div>
                          </div>
                          <div className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-gradient-to-r from-[#FFC72C] to-[#008060] rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-1">
                              🤝
                            </div>
                            <div>
                              <div className="font-semibold text-sm mb-1">
                              ...
                              <div className="text-xs text-muted-foreground">
                                Seamless inter-department connectivity
                              </div>
                            </div>
                          </div>
                          <div className="flex items-start gap-3">
                            <div className="w-6 h-6 bg-gradient-to-r from-[#008060] to-[#FF5722] rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 mt-1">
                              💡
                            </div>
                            <div>
                              <div className="font-semibold text-sm mb-1">
                              ...
                              <div className="text-xs text-muted-foreground">
                                Intelligent automation for enhanced UX
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-[#FF5722] to-[#8D153A] rounded-xl flex items-center justify-center">
                      <svg
                        className="w-6 h-6 text-white"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="p-4 bg-background/50 rounded-lg border border-border/30">
                        <div className="text-center mb-3">
                          <div className="w-10 h-10 bg-gradient-to-r from-[#FFC72C] to-[#FF5722] rounded-full flex items-center justify-center mx-auto mb-2">
                        ...
                        <p className="text-xs text-muted-foreground text-center leading-relaxed">
                          Open, honest communication and clear processes that
                          citizens can trust and understand.
                        </p>
                      </div>

                      <div className="p-4 bg-background/50 rounded-lg border border-border/30">
                        <div className="text-center mb-3">
                          <div className="w-10 h-10 bg-gradient-to-r from-[#008060] to-[#FFC72C] rounded-full flex items-center justify-center mx-auto mb-2">
                            <span className="text-white text-lg">⚡</span>
                          </div>
                          <h5 className="font-semibold text-sm">Excellence</h5>
                        </div>
                        <p className="text-xs text-muted-foreground text-center leading-relaxed">
                          Commitment to the highest quality standards in every
                          service we deliver to citizens.
                        </p>
                      </div>

                      <div className="p-4 bg-background/50 rounded-lg border border-border/30">
                        <div className="text-center mb-3">
                          <div className="w-10 h-10 bg-gradient-to-r from-[#FF5722] to-[#8D153A] rounded-full flex items-center justify-center mx-auto mb-2">
                            <span className="text-white text-lg">🤝</span>
                          </div>
                          <h5 className="font-semibold text-sm">Inclusivity</h5>
                        </div>
                        <p className="text-xs text-muted-foreground text-center leading-relaxed">
                          Ensuring equal access and opportunity for all Sri
                          Lankans, regardless of background.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12">
            ...
            <div className="group text-center p-6 sm:p-8 bg-card/90 dark:bg-card/95 backdrop-blur-md rounded-xl border border-border/50 hover:border-[#FFC72C]/70 hover:shadow-2xl transition-all duration-500 modern-card hover-lift">
              ...
              <h3 className="font-semibold mb-2 group-hover:text-[#FFC72C] transition-colors duration-300">
                {t.contactMethods.phone.title}
              </h3>
              <p className="text-muted-foreground mb-2 font-mono text-sm sm:text-base">
                {t.contactMethods.phone.number}
              </p>
              <p className="text-xs sm:text-sm text-muted-foreground">
                {t.contactMethods.phone.hours}
              </p>
            </div>
            ...
            <div className="group text-center p-6 sm:p-8 bg-card/90 dark:bg-card/95 backdrop-blur-md rounded-xl border border-border/50 hover:border-[#008060]/70 hover:shadow-2xl transition-all duration-500 modern-card hover-lift">
              ...
              <h3 className="font-semibold mb-2 group-hover:text-[#008060] transition-colors duration-300">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">
                {t.contactMethods.email.availability}
              </p>
            </div>
            ...
            <div className="group text-center p-6 sm:p-8 bg-card/90 dark:bg-card/95 backdrop-blur-md rounded-xl border border-border/50 hover:border-[#FF5722]/70 hover:shadow-2xl transition-all duration-500 modern-card hover-lift">
              ...
              <h3 className="font-semibold mb-2 group-hover:text-[#FF5722] transition-colors duration-300">
                {t.contactMethods.location.title}
              </h3>
              <p className="text-muted-foreground mb-2 text-sm sm:text-base">
                {t.contactMethods.location.address}
              </p>
              <p className="text-xs sm:text-sm text-muted-foreground">
                {t.contactMethods.location.description}
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div className="group p-4 sm:p-6 bg-background/50 dark:bg-background/30 rounded-xl border border-border/30 hover:border-[#FFC72C]/50 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <h4 className="font-semibold text-sm sm:text-base group-hover:text-[#FFC72C] transition-colors duration-300">
                    {t.faq.questions.forms.question}
                  </h4>
                </div>
                <div className="flex items-start gap-3">
              ...
              <div className="group p-4 sm:p-6 bg-background/50 dark:bg-background/30 rounded-xl border border-border/30 hover:border-[#008060]/50 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <h4 className="font-semibold text-sm sm:text-base group-hover:text-[#008060] transition-colors duration-300">
                    {t.faq.questions.official.question}
                  </h4>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-gradient-to-r from-[#008060] to-[#FFC72C] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    {t.faq.questions.official.answer}
                  </p>
                </div>
              </div>
              ...
              <div className="group p-4 sm:p-6 bg-background/50 dark:bg-background/30 rounded-xl border border-border/30 hover:border-[#FF5722]/50 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <h4 className="font-semibold text-sm sm:text-base group-hover:text-[#FF5722] transition-colors duration-300">
              ...
              <div className="group p-4 sm:p-6 bg-background/50 dark:bg-background/30 rounded-xl border border-border/30 hover:border-[#8D153A]/50 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <h4 className="font-semibold text-sm sm:text-base group-hover:text-[#8D153A] transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-4 mb-6">
              <div className="relative">
                ...
                <div
                  className="absolute inset-0 bg-gradient-to-r from-primary/10 to-accent/10 rounded-full blur-xl animate-pulse opacity-50"
                  style={{ animationDuration: "4s" }}
                ></div>
              </div>
              <div>
                <h3 className="text-2xl sm:text-3xl font-bold text-gradient mb-1">
                  GovLink
                </h3>
            ...
            <div className="flex gap-3 mb-6">
              <button
                className="group w-11 h-11 rounded-xl bg-card/80 dark:bg-card/60 border border-border/50 hover:border-[#1877F2]/50 hover:bg-[#1877F2]/10 flex items-center justify-center transition-all duration-300 hover:scale-110 modern-card"
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="text-muted-foreground group-hover:text-[#1877F2] transition-colors duration-300"
                >
              ...
              <button
                className="group w-11 h-11 rounded-xl bg-card/80 dark:bg-card/60 border border-border/50 hover:border-[#1DA1F2]/50 hover:bg-[#1DA1F2]/10 flex items-center justify-center transition-all duration-300 hover:scale-110 modern-card"
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="text-muted-foreground group-hover:text-[#1DA1F2] transition-colors duration-300"
                >
              ...
              <button
                className="group w-11 h-11 rounded-xl bg-card/80 dark:bg-card/60 border border-border/50 hover:border-[#0A66C2]/50 hover:bg-[#0A66C2]/10 flex items-center justify-center transition-all duration-300 hover:scale-110 modern-card"
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="text-muted-foreground group-hover:text-[#0A66C2] transition-colors duration-300"
                >
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              <div className="text-center p-2 sm:p-3 bg-card/60 dark:bg-card/40 rounded-lg border border-border/30 backdrop-blur-sm min-h-[60px] sm:min-h-[70px] flex flex-col justify-center">
                <div className="text-sm sm:text-base font-bold text-gradient mb-1 flex-shrink-0">
                  50K+
                </div>
                <div className="text-xs text-muted-foreground leading-tight break-words hyphens-auto">
                  {t.aboutStats.users}
                </div>
              </div>
              <div className="text-center p-2 sm:p-3 bg-card/60 dark:bg-card/40 rounded-lg border border-border/30 backdrop-blur-sm min-h-[60px] sm:min-h-[70px] flex flex-col justify-center">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a
                href="#services"
                className="group flex items-center gap-2 text-muted-foreground hover:text-primary transition-all duration-300 text-sm py-1"
              >
