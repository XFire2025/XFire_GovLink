...
const GlobalParticleBackground = () => {
 ...
 <div className="absolute inset-0 bg-gradient-to-tr from-[#FFC72C]/25 via-transparent to-[#8D153A]/25 "></div>
 </div>
 ...
 <div className="absolute top-4 sm:top-10 right-4 sm:right-6 md:right-10 w-8 sm:w-12 md:w-16 h-8 sm:h-12 md:h-16 bg-[#FFC72C]/30 sm:bg-[#FFC72C]/33 md:bg-[#FFC72C]/35 dark:bg-[#FFC72C]/15 dark:sm:bg-[#FFC72C]/18 dark:md:bg-[#FFC72C]/20 rounded-full blur-sm " style={{animationDelay: '1.5s'}}></div>
 ...
 <div className="absolute bottom-4 sm:bottom-10 left-4 sm:left-6 md:left-10 w-10 sm:w-15 md:w-20 h-10 sm:h-15 md:h-20 bg-[#008060]/25 sm:bg-[#008060]/28 md:bg-[#008060]/30 dark:bg-[#008060]/12 dark:sm:bg-[#008060]/14 dark:md:bg-[#008060]/15 rounded-full blur-md " style={{animationDelay: '3.5s'}}></div>
...
const Hero = () => {
 ...
 <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-tight mb-3 sm:mb-4" style={{textShadow: '0 2px 8px rgba(0,0,0,0.3), 0 4px 16px rgba(0,0,0,0.1)'}}>
 ...
 <div className="w-16 sm:w-20 md:w-24 h-0.5 sm:h-1 bg-gradient-to-r from-[#FFC72C] to-[#FF5722] mx-auto rounded-full"></div>
 </div>
 
 {/* Subtitle - Mobile Responsive */}
 <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-8 sm:mb-10 md:mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up px-2 sm:px-0" style={{animationDelay: '0.2s', textShadow: '0 1px 4px rgba(0,0,0,0.2)'}}>
 <span>Ask questions,</span>{' '}
 <span>find services,</span>{' '}
 <span>and access information instantly.</span>{' '}
 <span>Your direct link to public services is here.</span>
 </p>
 ...
 <button 
 type="submit" 
 className="absolute right-2 sm:right-3 md:right-4 top-1/2 -translate-y-1/2 p-3 sm:p-3.5 md:p-4 bg-gradient-to-r from-[#FFC72C] to-[#FF5722] hover:from-[#FF5722] hover:to-[#8D153A] rounded-lg sm:rounded-xl transition-all duration-300 hover:scale-110 shadow-glow group "
 >
...
const Features = () => {
 ...
 <span>GovLink is designed to make your interaction</span>{' '}
 <span>with government services seamless and efficient.</span>
 </p>
 </div> 
 {/* Feature Cards */}
...
const About = () => (
 ...
 <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#008060]/20 to-[#FFC72C]/20 px-4 py-2 rounded-full border border-[#008060]/30 mb-6 ">
 ...
 <span className="">Bridging the Gap</span>{' '}
 <span className="text-gradient ">Between Citizens & Government</span>
 </h2>
 
 <p className="text-lg sm:text-xl text-muted-foreground mb-8 leading-relaxed ">
 <span className="">GovLink was born from a simple vision:</span>{' '}
 <span className="">making government services accessible, transparent, and efficient for every Sri Lankan citizen.</span>
 </p>
 ...
 <button className="bg-gradient-to-r from-[#FFC72C] to-[#FF5722] hover:from-[#FF5722] hover:to-[#8D153A] text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 hover:scale-105 shadow-glow ">
 Learn More
 </button>
 <button className="border-2 border-[#008060] text-[#008060] hover:bg-[#008060] hover:text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 hover:scale-105 ">
 Our Mission
 </button>
 </div>
 </div>
...
const Contact = () => (
 ...
 <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#8D153A]/20 to-[#FF5722]/20 px-4 py-2 rounded-full border border-[#8D153A]/30 mb-6 ">
 ...
 <span className="">Have questions about government services?</span>{' '}
 <span className="">Our support team is ready to assist you.</span>
 </p>
 </div>
