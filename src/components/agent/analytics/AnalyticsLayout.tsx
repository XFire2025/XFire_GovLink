...
// EXACT SAME Lotus Icon as Other Layouts with Sri Lankan Flag Colors
...
// EXACT SAME Sri Lankan Background Component as Other Layouts
...
const AnalyticsLayout: React.FC<AnalyticsLayoutProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden theme-transition-slow">
      {/* EXACT SAME Sri Lankan Background as Other Layouts */}
      <SriLankanBackground />
      
      {/* Header - EXACT SAME styling as Other Layouts */}
      <header className="sticky top-0 z-50 w-full bg-background/98 dark:bg-card backdrop-blur-md border-b border-border/30 dark:border-border/50 shadow-sm dark:shadow-lg">
        <nav className="container mx-auto flex items-center justify-between px-4 py-3 md:px-6 md:py-4">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            {/* Notification Bell - Enhanced with Other Layout Styling */}
            ...
            {/* Language Dropdown - EXACT SAME as Other Layouts */}
            <div className="relative">
              <button
            ...
            {/* Profile Dropdown - Enhanced with Other Layout Styling */}
            <div className="relative">
              <button
      ...
      <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 relative z-10">
        {/* Title Section - Clean without lotus, consistent with Other Layouts */}
