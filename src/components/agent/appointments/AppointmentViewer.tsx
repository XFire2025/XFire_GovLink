// src/components/agent/appointments/AppointmentViewer.tsx
"use client";
...
const viewerTranslations: Record<Language, {
  ...
  ta: {
    ...
    loadingError: 'கோப்பை ஏற்றுவதில் பிழை',
...
const AppointmentViewer: React.FC<AppointmentViewerProps> = ({
  files,
  isOpen,
  onClose,
  initialFileIndex = 0,
  ...
  const handleDownload = (file: AppointmentFile) => {
