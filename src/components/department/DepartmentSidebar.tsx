...
import { Menu, LayoutDashboard, Users, FileText, BarChart3, Settings } from "lucide-react";
...
export default function DepartmentSidebar() {
  ...
  return (
    <>
      ...
      <div className={`fixed lg:sticky top-0 h-screen bg-gradient-to-b from-card/95 via-card/90 to-card/80 dark:from-card/98 dark:via-card/95 dark:to-card/90 border-r border-border/50 backdrop-blur-md flex flex-col transition-all duration-300 ease-in-out shadow-2xl modern-card z-40 overflow-hidden ${isCollapsed ? "w-16" : "w-64"} ${isMobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}>
