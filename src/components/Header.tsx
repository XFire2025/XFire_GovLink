...
const NavbarLotusIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 100 100">
    {/* Outer layer petals */}
    <path
      d="M50,20 Q40,35 45,50 Q50,45 55,50 Q60,35 50,20 Z"
      fill="#8D153A"
      opacity="0.8"
    />
    <path
    ...
    {/* Middle layer petals */}
    <path
      d="M50,25 Q42,37 46,50 Q50,47 54,50 Q58,37 50,25 Z"
      fill="#FF5722"
      opacity="0.9"
    ...
    <path
      d="M50,32 Q45,40 47,50 Q50,48 53,50 Q55,40 50,32 Z"
      fill="#FFC72C"
        ...
        <nav className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link
              ...
              className="px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent/50 rounded-lg transition-all duration-300 relative group"
            >
              <span className="relative z-10">{t("navigation.feedback")}</span>
              <div className="absolute inset-0 bg-gradient-to-r from-[#FFC72C]/0 to-[#FF5722]/0 group-hover:from-[#FFC72C]/5 group-hover:to-[#FF5722]/5 rounded-lg transition-all duration-300"></div>
            </Link>
            <button
              ...
              <div className="px-4 py-6 space-y-4">
                <div className="flex flex-col space-y-3">
                  ...
                  <Link
                    ...
                    className="text-left px-4 py-3 text-muted-foreground hover:text-foreground hover:bg-accent/50 rounded-lg transition-all duration-200 block"
                  >
